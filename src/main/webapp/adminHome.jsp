...
<section>
  ...
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact OM PRAKASH.
Designed & Developed by OM PRAKASH Team</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @ OM PRAKASH :: 2020-2023</h5></center> 
  <hr class="new1">
<br>
</body>
</html>